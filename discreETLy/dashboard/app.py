...
from dashboard.service.mysql import PostgreSQLClient
...
def create_app(settings_override=None):
    ...
    app.airflow_data_provider = AirflowDBDataProvider(app.config, app.logger, PostgreSQLClient(app.config, app.logger))
